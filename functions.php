<?php
/**
 * My_WP_Theme_Boilerplate functions and definitions
 *
...
if ( ! function_exists( 'my_wp_theme_boilerplate_setup' ) ) :
	 ...
	 */
	function my_wp_theme_boilerplate_setup() {
		/*
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'my_wp_theme_boilerplate_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'my_wp_theme_boilerplate_setup' );
 ...
 */
function my_wp_theme_boilerplate_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'my_wp_theme_boilerplate_content_width', 640 );
}
add_action( 'after_setup_theme', 'my_wp_theme_boilerplate_content_width', 0 );
...
add_action( 'widgets_init', 'my_wp_theme_boilerplate_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'my_wp_theme_boilerplate_scripts' );
